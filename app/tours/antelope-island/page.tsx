    ...
    <>
      ...
      <Section title="Tour Overview">
        <div className="space-y-4 text-sm text-sand/80 max-w-3xl">
          <p>
            This private four-hour wildlife experience (from pickup to drop-off) explores the sweeping landscapes and diverse ecosystems of Antelope Island. Expect a scenic drive with views of the Great Salt Lake and Wasatch Mountains, along with stops for wildlife sightings. We’ll watch for bison, pronghorn, mule deer, and seasonal birdlife, with opportunities for photography and ecological interpretation throughout.
          </p>
          <p>
            Every tour is exclusive to your group and shaped by real-time conditions, allowing an unhurried pace and time to focus on the moments that matter most to you.
          </p>
        </div>
      </Section>
      ...
      <Section title="Why This Tour Is Different">
        <div className="space-y-4 text-sm text-sand/80 max-w-3xl">
          <p>
            This experience is fully private, giving you space, calm, and the freedom to focus on what interests you most. The pace is flexible, adapting to wildlife, lighting, and the natural rhythm of the day rather than a fixed script. Guided by a professionally trained safari guide with deep knowledge of the region, every moment gains context and clarity.
          </p>
          <p>
            It’s an intentional, personal way to explore Antelope Island—designed for guests who value depth, presence, and expert interpretation.
          </p>
        </div>
      </Section>
