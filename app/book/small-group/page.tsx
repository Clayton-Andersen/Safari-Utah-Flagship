    ...
    <>
      ...
      >
        <div className="max-w-3xl space-y-4 text-sm text-sand/80">
          ...
          <p>
            <Link href="/book" className="underline text-sand/80 hover:text-sand">
      ...
      <Section title="Small-Group Tour">
        <div className="max-w-3xl rounded-2xl border border-sand/20 bg-night/60 p-6 text-sm text-sand/80 space-y-4">
          ...
          <BokunButton
            buttonId="bokun_c48ece45_b1a3_4b75_bfd3_bc3fea4ade36"
            dataSrc="https://widgets.bokun.io/online-sales/af390726-dee6-4233-8c58-0c0de47938d0/experience/1174682?partialView=1"
