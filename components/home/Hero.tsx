      ...
      <div className="relative z-10 flex h-full items-center">
        <div className="mx-auto max-w-6xl px-4">
          <p className="mb-3 text-xs uppercase tracking-[0.28em] text-sand/85">
            Private Nature and wildlife tours from Salt Lake City
          </p>
          ...
          <p className="mb-8 max-w-xl text-sm text-sand/100 lg:text-base">
            Step into the wild with private and small-group wildlife tours led
            by an expert safari-trained guide. Safari Utah brings African-inspired
            guiding to Utah&apos;s most remarkable landscapes, with calm pacing,
            meaningful wildlife encounters, and a deeper understanding of place.
          </p>
